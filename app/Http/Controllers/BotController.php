    ...
    public function index(Request $request)
    {
        ...
        if (isset($request->input('callback_query')['data'])) {
            ...
            if ($callBackFromUser == "1") {
                ...
                $expertGrades = ['LEAD', 'SENIOR'];
                $telega_users = DB::table('telega_users')->where('grade', $expertGrades)->pluck('userId');
                ...
                $telega_users = DB::table('telega_users')->where('grade', $newGrades)->pluck('userId');
                ...
                $telegram->sendMessage($telegramUserId, $telegram->makeQuestion());
